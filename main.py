...
5. Specify how many AI-generated Q&As you want.
6. If you have your own specific questions, enter them in the "User Questions" box, one question per line.
...
if generate_button:
    ...
    if not parsed_faqs and not user_parsed_faqs:
        ...
        st.session_state["combined_faqs"] = format_all_faqs(parsed_faqs, user_parsed_faqs)
